            ...
            <div className="col-md-5 col-lg-4 order-md-last">
              <div className="card mb-4">
                ...
                <div className="card-body">
                  ...
                  {/* QR Code moved here - directly under Order Summary */}
                  <div className="text-center mt-3">
                    <img
                      ...
                      style={{
                        ...
                        borderRadius: "10px",
                        boxShadow: "0 4px 8px rgba(0,0,0,0.1)" // Added slight shadow for better appearance
                      }}
                    />
                    <p className="mt-2 text-muted">Scan to pay</p>
                  </div>
                </div>
              </div>
            </div>
